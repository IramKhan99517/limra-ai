        ...
        {done ? (
          ...
          <>
            <button
              ...
              className="mt-8 flex w-full items-center justify-center gap-3 rounded-full border border-ink-line bg-ink px-5 py-3 text-sm font-medium text-linen transition hover:border-dune"
            >
